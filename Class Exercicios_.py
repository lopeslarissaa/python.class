...
cliente1 = Cliente("Gabriel", 1995, "Masculino", 1000, "Rua A, 123")
cliente2 = Cliente("Andressa", 1998, "Feminino", -500, "Rua B, 456")
cliente3 = Cliente("Felipe", 2002, "Masculino", 200, "Rua C, 789", ativo=False)
...
class Exercicios:
    ...
    def exercicio5(self):
        alunos = ["Gabriel", "Andressa", "Felipe", "Ana"]
